...
function createPost() {
  ...
  var postBody = document.getElementById("postText").value;
  ...
  var templateHTML = templateFn({ 'postTitle': postTitle, 'postBody': postBody, 'poster': poster });
  var pageTemplatHTML = pageTemplateFn({'post': templateHTML})
